...
turing_model = waning_model_intercept
initial_params = make_initial_params_intercept(p, obs_df, 4, rng)
...
plot(chain[ix_start:end], [:tau, :exp_intercept], seriestype = :traceplot)
