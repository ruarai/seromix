@model function waning_model_age_effect_2(
    ...
    log_likelihood = general_waning_likelihood(
        ...
        observed_titre,
        model_cache,
        individual_waning_age_effect_2!,
...
function individual_waning_age_effect_2!(
    params,
...
turing_function_to_waning_function(model_f::typeof(waning_model_age_effect_2)) = individual_waning_age_effect_2!