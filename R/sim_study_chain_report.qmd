...
model_data <- read_model_data("runs/sim_study_hanam_2018_3/model_data.hdf5")

chain <- read_chain("runs/sim_study_hanam_2018_3/chain.parquet")
```
...
ggplot() +
  ...
  geom_hline(yintercept = sum(model_data$infections_matrix))
