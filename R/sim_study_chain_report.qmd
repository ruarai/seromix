...
params:
  model_data_file: runs/sim_study_hanam_2018_4/1/model_data.hdf5
  chain_file: runs/sim_study_hanam_2018_4/1/chain_bernoulli_0.5_uncorrected.parquet
---
...
ggplot() +
  ...
  geom_tile(aes(x = strain_year, y = ix_subject, fill = n),
            alpha = 0.5,
             strains_observed) +
  geom_point(aes(x = year_observed, y = ix_subject),
             size = 0.5,
