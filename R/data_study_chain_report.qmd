...
params:
  model_data_file: runs/fluscape_2009_HI/model_data.hdf5
  chain_file: runs/fluscape_2009_HI/chain_prior_50_corrected.parquet
---
...
warmup_steps <- min(5000, max(chain$.iteration) - 1)
