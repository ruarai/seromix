...
model_data <- read_model_data("runs/sim_study_simple_1/model_data.hdf5")

chain <- read_chain("runs/sim_study_simple_1/chain.parquet")
```
...
ggplot() +
  ...
  geom_point(aes(x = ix_t, y = ix_subject), model_data$infections, size = 0.5, stroke = 0.3, colour = "black") +
